...
### Added
- `TestFactory.attributes_for(name, traits: [], **overrides)` — returns attribute hash without firing `after_build` callbacks or resolving associations; mirrors FactoryBot `attributes_for`
